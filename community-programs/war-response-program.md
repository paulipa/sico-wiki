...
**The characters on default in the corporation are alt characters in alpha state.** The idea behind this is that anyone in the community is able to make a new alpha character and help us in our war efforts to protect the assets we have without the need to dangering their main character or the need to move around in space.

> We encourage all of our members to make new alpha accounts to this corporation. You will be able to keep the skills training even if you would not actively log in to your war alt and have an character ready for combat at all times.
{.is-success}
...
1. Next you want to create a **caldari character**. This will save you some skill points.
1. OPTIONAL: Since we want to have a tiny bit or RP in this corporation please pick a Harry Potter series themed name. You can create variations of the names if the name you are looking for is not available but try to keep it somehow related. This way when our horde of wizards enters locals space people will know shit is going down! You can use this list for help https://en.wikipedia.org/wiki/List_of_Harry_Potter_characters
...
![sltrn-show-plan.jpg](/sltrn-show-plan.jpg =200x)
1. Click on the buy missing skillbooks button
![sltrn-buy-missing-skills.jpg](/sltrn-buy-missing-skills.jpg =400x)
1. After this you will be able to add the skills on your queue by pressing on the `add skills to training queue`. Your training may be on pause on default as the plan might be too long at this point.
![sltrn-skills-bought.jpg](/sltrn-skills-bought.jpg =400x)
1. Open up your skill queue and click on the `apply skill points` this is where you will apply the 1mil of points from the buddy invite to fulfill the base part of the plan.
![sltrn-apply-skillpoints.jpg](/sltrn-apply-skillpoints.jpg =500x)
1. **Start your skill training** and continue training the skills in the plan. The rest of the skills in this plan will improve the performance of the ferox on its own to the absolutely maximum alpha level performance that the ship can be trained for.
![sltrn-skills-in-training.jpg](/sltrn-skills-in-training.jpg =500x)

> You are now able to fly both the alpha ferox and the alpha osprey. Your skills will continue to train and improve the performance of the ferox over time.
{.is-success}
